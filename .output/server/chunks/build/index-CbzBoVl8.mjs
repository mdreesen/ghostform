...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      let _temp0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full max-w-[440px] mx-auto px-6 py-8 font-sans" }, _attrs))} data-v-1c08fbc4>`);
      if (notConfigured.value) {
        _push(`<div class="text-center py-10" data-v-1c08fbc4><p class="gf-display text-[26px] mb-3" data-v-1c08fbc4>This form isn&#39;t set up yet</p><p class="text-[14px] leading-relaxed" style="${ssrRenderStyle({ "color": "var(--gf-muted)" })}" data-v-1c08fbc4> Open your GhostForm link once while you have signal. After that it works offline, and you can add it to your home screen. </p></div>`);
      } else if (!aiResult.value) {
        _push(`<div data-v-1c08fbc4><div class="flex items-center gap-2.5 mb-8" data-v-1c08fbc4><span class="gf-eyebrow" style="${ssrRenderStyle({ "color": "var(--gf-muted)" })}" data-v-1c08fbc4>`);
        if (!isOnline.value) {
          _push(`<!--[--><span class="w-1.5 h-1.5 rounded-full shrink-0" style="${ssrRenderStyle({ background: isOnline.value ? "var(--gf-accent)" : "var(--gf-muted)" })}" data-v-1c08fbc4></span><span data-v-1c08fbc4>Offline — saved and sent when signal returns</span><!--]-->`);
        } else {
          _push(`<!---->`);
        }
        _push(`</span></div><div class="flex items-baseline justify-between mb-3" data-v-1c08fbc4><span class="gf-eyebrow" style="${ssrRenderStyle({ "color": "var(--gf-muted)" })}" data-v-1c08fbc4>${ssrInterpolate(String(step.value + 1).padStart(2, "0"))} — ${ssrInterpolate(String(questions.value?.length || 0).padStart(2, "0"))}</span><span class="gf-eyebrow" style="${ssrRenderStyle({ "color": "var(--gf-muted)" })}" data-v-1c08fbc4>${ssrInterpolate(Math.round((step.value + 1) / (questions.value?.length || 1) * 100))}% </span></div><div class="h-px w-full mb-10" style="${ssrRenderStyle({ "background": "var(--gf-hair)" })}" data-v-1c08fbc4><div class="h-px transition-all duration-500 ease-out" style="${ssrRenderStyle({ width: `${(step.value + 1) / (questions.value?.length || 1) * 100}%`, background: "var(--gf-accent)" })}" data-v-1c08fbc4></div></div><div data-v-1c08fbc4><label${ssrRenderAttr("for", questions.value[step.value]?.id)} class="gf-display block text-[27px] leading-[1.2] mb-2" data-v-1c08fbc4>${ssrInterpolate(questions.value[step.value]?.label)}</label><p class="gf-eyebrow mb-6" style="${ssrRenderStyle({ "color": "var(--gf-muted)" })}" data-v-1c08fbc4>${ssrInterpolate(currentRequired.value ? "Required" : "Optional — skip if you like")}</p><input${ssrRenderAttrs((_temp0 = mergeProps({
          ...
          autofocus: ""
        }), mergeProps(_temp0, ssrGetDynamicModelProps(_temp0, answers.value[questions.value[step.value]?.id]))))} data-v-1c08fbc4>`);
        if (fieldError.value) {
          _push(`<p${ssrRenderAttr("id", `${questions.value[step.value]?.id}-error`)} class="text-[13px] mt-3 leading-relaxed" style="${ssrRenderStyle({ "color": "var(--gf-accent)" })}" role="alert" data-v-1c08fbc4>${ssrInterpolate(fieldError.value)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        ...
        _push(`<div class="mt-10" data-v-1c08fbc4><div class="flex items-center gap-3" data-v-1c08fbc4>`);
        if (step.value > 0) {
          _push(`<button class="px-5 py-3.5 text-[11px] uppercase tracking-[0.12em] font-semibold transition-colors" style="${ssrRenderStyle({ "border": "1px solid var(--gf-hair)", "color": "var(--gf-muted)" })}" data-v-1c08fbc4> Back </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button class="flex-1 px-6 py-3.5 text-[11px] uppercase tracking-[0.12em] font-semibold transition-opacity hover:opacity-90" style="${ssrRenderStyle({ background: "var(--gf-accent)", color: "var(--gf-bg)" })}" data-v-1c08fbc4>${ssrInterpolate(step.value === questions.value?.length - 1 ? "Send it" : "Next")}</button></div>`);
        if (unref(use_image_upload)) {
          _push(`<button class="mt-4 gf-eyebrow transition-opacity hover:opacity-70" style="${ssrRenderStyle({ "color": "var(--gf-muted)" })}" data-v-1c08fbc4>${ssrInterpolate(useUploadImage.value ? "— Cancel upload" : "+ Add a photo")}</button>`);
        } else {
          _push(`<!---->`);
        }
        if (useUploadImage.value) {
          _push(`<div class="mt-5" data-v-1c08fbc4>`);
        ...
        _push(`</div>`);
        if (setError.value) {
          _push(`<div class="mt-6" data-v-1c08fbc4>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-1c08fbc4"]]), { __name: "AppGhostForm" });
...
//# sourceMappingURL=index-CbzBoVl8.mjs.map
